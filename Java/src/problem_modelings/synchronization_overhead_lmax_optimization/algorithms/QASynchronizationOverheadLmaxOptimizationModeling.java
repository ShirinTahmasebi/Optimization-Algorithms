package problem_modelings.synchronization_overhead_lmax_optimization.algorithms;
...
import problem_modelings.synchronization_overhead_lmax_optimization.model_specifications.SynchronizationOverheadLmaxOptimizationModelingAbstract;
import problem_modelings.synchronization_overhead_lmax_optimization.model_specifications.SynchronizationOverheadLmaxOptimizationModelingPlainOldData;

import java.util.*;

public class QASynchronizationOverheadLmaxOptimizationModeling extends SynchronizationOverheadLmaxOptimizationModelingAbstract implements QAModelingInterface {
    private QAPlainOldData qaDataStructure;

    public QASynchronizationOverheadLmaxOptimizationModeling(SynchronizationOverheadLmaxOptimizationModelingPlainOldData modelPlainOldData, QAPlainOldData qaDataStructure) {
    ...
    public Pair<Double, Double> calculateCost(int currentReplicaNum) {
        // TODO: Add Synchronization Cost Here
    ...
    public QAResultBaseInterface getResult() {
        // TODO: Check - Maybe some other fields will be needed
